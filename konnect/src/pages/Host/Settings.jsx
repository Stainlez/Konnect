  ...
  return (
    ...
    <ul className="space-y-8">
      <li className='hover:bg-gray-400 rounded-md'>
        <Link to="/dashboard/settings/account-type" className="block py-2 font-semibold text-gray-600 hover:text-gray-800">
          User Account Type
        </Link>
      </li>
      <li className='hover:bg-gray-400 rounded-md'>
        <Link to="/dashboard/notification" className="block py-2 font-semibold text-gray-600 hover:text-gray-800">
          Notifications
        </Link>
      </li>
      <li className='hover:bg-gray-400 rounded-md'>
        <Link to="/resetpassword" className="block py-2 font-semibold text-gray-600 hover:text-gray-800">
          Edit Password
        </Link>
      </li>
      <li className='hover:bg-gray-400 rounded-md'>
