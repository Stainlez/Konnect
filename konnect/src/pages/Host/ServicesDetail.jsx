...
const ServiceDetails = () => {
  ...
  return (
    <div className=" mx-auto p-16  space-y-7 bg-textColor min-h-screen">
      <Link to={`..${search}`} relative="path" className="flex">
        <img src={back} alt="" className="w-5 h-3 self-center" />{" "}
      ...
      <div>
        ...
        {service.services && service.services.length > 0 ? (
              ...
              {service.services.map((serviceItem, index) => (
                <div key={index} className="inline-flex items-center">
                  <img
                    src={stop}
                    alt="stop"
                    className="h-3 object-contain mr-2"
                  />
                  {serviceItem}
                </div>
              ))}
          ...
          <pre className="text-center text-gray-500">
            This page has not defined their services
          </pre>
        )}
      </div>
          ...
          <div className="rounded-lg">
            <div className="space-y-6">
              {service.reviews.map((review) => (
                <div
                  key={review.id}
                  className="bg-customGray p-4 rounded-lg shadow-sm"
                >
