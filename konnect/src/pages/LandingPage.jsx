    ...
    <div className="bg-textColor max-w-full">
      ...
      <div className="container flex flex-col justify-center items-center p-5 min-h-screen max-w-full bg-[url('/AnimateSVG.svg')] bg-cover animate-[backgroundMove_2s_infinite]">
        <div className="flex-col mt-24 space-y-5 max-w-2xl mx-auto">
          ...
          <p className="text-textColor text-center text-5xl md:text-7xl lg:text-7xl font-extrabold">
            Discover, Share and Thrive with Konnect
          </p>
          <p className="text-textColor pt-5 text-center text-sm md:text-base lg:text-lg">
            Join a vibrant community rooted in entrepreneurship, access
            essential tools and connect with like-minded individuals to grow
            your network.
          </p>
...
Business has been booming as well.</p>
      ...
      <div className="bg-#E6E6E6">
        <h2 className="text-2xl md:text-3xl lg:text-4xl text-black font-bold text-center pt-5 mt-12 mb-8">
          Testimonials
        </h2>
        <TestimonialsSection />
      </div>
